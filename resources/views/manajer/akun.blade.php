                            ...
                            <form action="{{route('update-profile')}}" method="post" class="">
                                ...
                                <div class="card-body card-block">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nf-email" name="name" placeholder="Enter Email.." value="{{ Auth::user()->name }}"
                                               class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="nf-email" class="form-control-label disabled">Email</label>
                                        <input type="email" id="nf-email" name="nf-email" placeholder="Enter Email.." value="{{ Auth::user()->email }}"
